...
public class MainActivity extends AppCompatActivity {
    ...
    Button btn_add; //member var for each item in the app
    EditText et_item;
    ...
    //Handle the result of the edit activiy
    @Override
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (resultCode == RESULT_OK && requestCode == EDIT_TEXT_CODE) {
            ...
            //Persist the changes
            saveItems();
            Toast.makeText(getApplicationContext(), "Item opdated successfully!", Toast.LENGTH_SHORT).show();
        } else {
